...
par = {}
parts = 100
par['E'] = {'Min': 0.5e11, 'Max': 4e11}
par['rho'] = {'Min': 1500, 'Max': 9000}
par['dLimit'] = {'Min': 0.5e8, 'Max': 4e8}
par['strike'] = {'Min': 1, 'Max': 10}

def get_list(Min, Max):
    return list(map(lambda x: round(x, 6), np.arange(Min, Max+0.01, (Max-Min)/(parts-1))))

e0 = tuple(enumerate(get_list(**par['E'])))
e1 = tuple(enumerate(get_list(**par['rho'])))
e2 = tuple(enumerate(get_list(**par['dLimit'])))
e3 = tuple(enumerate(get_list(**par['strike'])))

#print(get_list(**par['E']))
#print(get_list(**par['rho']))
#print(get_list(**par['dLimit']))
#print(get_list(**par['strike']))


new_parts = 199
def get_new_list(Min, Max):
    return list(map(lambda x: round(x, 6), np.arange(Min, Max+0.01, (Max-Min)/(new_parts-1))))[1::2]

#print(get_new_list(**par['E']))
#print(get_new_list(**par['rho']))
#print(get_new_list(**par['dLimit']))
print(get_new_list(**par['strike']))

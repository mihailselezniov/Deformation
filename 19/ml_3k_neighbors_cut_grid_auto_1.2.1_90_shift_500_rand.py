...
ex_name = '16_1_mlp_1_500_rand.txt'
...
while 1:
    ...
    X = Xx + shift[len(threads)-2]# (0.02*(len(threads)-1))
    ...
    model = MLPClassifier(activation='relu', solver='adam', hidden_layer_sizes=(50,), max_iter=100000, random_state=42)

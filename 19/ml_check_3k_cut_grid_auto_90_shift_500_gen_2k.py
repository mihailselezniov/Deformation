...
def get_raw(par_inxs):
    return [get_list4(**par[par_name])[int(par_inxs[pi]*100)] for pi, par_name in enumerate(order_par)]
...
for cut in [1600, 1700, 1800, 1900, 2000]:
    #cut = 200
    print('\n\n\n', '#'*10, cut, '#'*10)
    ...
    x_train = np.array(list(map(get_raw2, x_train)))
    x_train = (x_train - extreme_values.min(axis=0)) / (extreme_values.max(axis=0) - extreme_values.min(axis=0))
    #print(x_train)
    ...
    fit_model(MLPClassifier(max_iter=100000))
    ...
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100)))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100)))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100, 100)))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100), max_iter=100000))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100), max_iter=100000))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100, 100), max_iter=100000))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100), activation='tanh'))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100), activation='tanh'))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100, 100), activation='tanh'))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100), activation='tanh', max_iter=100000))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100), activation='tanh', max_iter=100000))
    fit_model(MLPClassifier(hidden_layer_sizes=(100, 100, 100, 100), activation='tanh', max_iter=100000))

...
for cut in [100, 200, 300, 400, 500]:
    ...
    fit_model(MLPClassifier(activation='relu', solver='adam', hidden_layer_sizes=(50, 50, 50), random_state=42))
    fit_model(MLPClassifier(activation='relu', solver='adam', hidden_layer_sizes=(70, 70, 70), random_state=42))
    fit_model(MLPClassifier(activation='tanh', solver='adam', hidden_layer_sizes=(90, 90, 90), random_state=42))
    fit_model(MLPClassifier(activation='tanh', solver='adam', hidden_layer_sizes=(70, 70, 70), random_state=42))
...
/opt/anaconda3/lib/python3.8/site-packages/sklearn/neural_network/_multilayer_perceptron.py:582: ConvergenceWarning: Stochastic Optimizer: Maximum iterations (200) reached and the optimization hasn't converged yet.
  warnings.warn(
y_pred {1: 32225917, 0: 10820804}
Accuracy: 0.8933368002640666
Confusion matrix:
[[ 7987940  1758637]
 [ 2832864 30467280]]
...
ROC AUC: 0.8672465020972069
PR AUC: 0.9308087843586911
---------- End MLPClassifier ----------
...
/opt/anaconda3/lib/python3.8/site-packages/sklearn/neural_network/_multilayer_perceptron.py:582: ConvergenceWarning: Stochastic Optimizer: Maximum iterations (200) reached and the optimization hasn't converged yet.
  warnings.warn(
y_pred {1: 31780913, 0: 11265808}
Accuracy: 0.8887103851649931
Confusion matrix:
[[ 8110866  1635711]
 [ 3154942 30145202]]
Precision, recall and f1-score:
...
ROC AUC: 0.8687166283696413
PR AUC: 0.9319564168595891
---------- End MLPClassifier ----------
...
/opt/anaconda3/lib/python3.8/site-packages/sklearn/neural_network/_multilayer_perceptron.py:582: ConvergenceWarning: Stochastic Optimizer: Maximum iterations (200) reached and the optimization hasn't converged yet.
  warnings.warn(
y_pred {1: 34269918, 0: 8776803}
Accuracy: 0.9062063751615367
Confusion matrix:
[[ 7242936  2503641]
 [ 1533867 31766277]]
Precision, recall and f1-score:
           ...
           0       0.83      0.74      0.78   9746577
           1       0.93      0.95      0.94  33300144

    accuracy                           0.91  43046721
   macro avg       0.88      0.85      0.86  43046721
weighted avg       0.90      0.91      0.90  43046721

ROC AUC: 0.8485321261585652
PR AUC: 0.9198793353619434
'''

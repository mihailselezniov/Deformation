...
type Fiber struct {
    ...
    POINTS_NUMBER, POINTS_NUMBER_minus_1, POINTS_PER_FIBER, NUMBER_OF_FRAMES, TEMP_apply_pressure_points2, broken, broken_fracture  int
...
func start() {
    ...
    fmt.Println("#", arg, f.test_fiber(), f.broken_fracture)
    return

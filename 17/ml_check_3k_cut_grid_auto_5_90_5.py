...
#-extreme_feature_values = extreme_values**2

#print(list(map(list, list(extreme_values))))
#print('-'*5)
#print(list(map(list, list(extreme_feature_values))))
#print('-'*5)
#extreme_values2 = np.concatenate((extreme_values, extreme_feature_values), axis=1)
#print(list(map(list, list(extreme_values2))))

#-extreme_values = np.concatenate((extreme_values, extreme_feature_values), axis=1)
...
x_test = (x_test - 0.5) * 2
x_test = np.concatenate((x_test, np.sin(x_test * 6)), axis=1) 
...
for cut in [100, 200, 300, 400, 500]:
    ...
    #feature_train = x_train**2
    #x_train = np.concatenate((x_train, feature_train), axis=1)

    x_train = (x_train - extreme_values.min(axis=0)) / (extreme_values.max(axis=0) - extreme_values.min(axis=0))
    x_train = (x_train - 0.5) * 2
    x_train = np.concatenate((x_train, np.sin(x_train * 6)), axis=1)
